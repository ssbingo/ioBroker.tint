...
const LIGHT_STATES = [
	...
	{ sub: 'state.x', type: 'number', role: 'level', read: true, write: true },
	{ sub: 'state.y', type: 'number', role: 'level', read: true, write: true },
];
...
const SENSOR_GENERIC_VALUE_STATE = { sub: 'value.raw', type: 'string', role: 'text', read: true, write: false };
...
const COVER_STATES = [
	{ sub: 'info.name', type: 'string', role: 'info.name', read: true, write: false },
	{ sub: 'info.modelid', type: 'string', role: 'text', read: true, write: false },
	{ sub: 'info.manufacturer', type: 'string', role: 'text', read: true, write: false },
	{ sub: 'info.reachable', type: 'boolean', role: 'indicator.reachable', read: true, write: false },
	{ sub: 'info.uniqueid', type: 'string', role: 'text', read: true, write: false },
	{
		sub: 'state.position',
		type: 'number',
		role: 'level.blind',
	...
	{ sub: 'state.stop', type: 'boolean', role: 'button.stop', read: false, write: true, def: false },
];
