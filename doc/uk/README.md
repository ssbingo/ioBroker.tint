...
| `scenes.<name>` | boolean | W | Встановіть `true`, щоб викликати цю сцену |
...
| `state.stop` | boolean | W | Запишіть `true`, щоб зупинити рух |
...
### 0.3.9 (2026-06-28)
* (ssbingo) Виправлення: @mui/material devDep знижено з v9 до v6 — fallback-бандл v9 спричиняв збій Emotion v6 Admin під час узгодження спільних модулів MF, що унеможливлювало відкриття налаштувань

### 0.3.8 (2026-06-28)
* (ssbingo) Додано вкладку бічної панелі Admin для керування пристроями (Освітлення, Групи, Розетки, Жалюзі, Вимикачі, Датчики, Термостати); активація через «enableAdminTab» на вкладці Підключення в налаштуваннях адаптера
### 0.3.7 (2026-06-28)
* (ssbingo) Виправлення: атрибути xs/md/lg/xl додано до елементів staticText (E5507); ключ i18n 'deCONZ Pairing' додано (E5612); adapter.setTimeout передано до DeconzWebSocket (E5005); CI оновлено до Node.js 24, adapter-tests залежить від check-and-lint (E3022/E3014); cooldown dependabot та ігнорування мажорних версій @types/node (E8917/E8915)
### 0.3.6 (2026-06-28)
* (ssbingo) Виправлення: URL репозиторію в package.json встановлено у форматі HTTPS, щоб перевірник адаптерів ioBroker міг розпізнати raw-URL GitHub
### 0.3.5 (2026-06-28)
