  ...
  function PairingPanel(props) {
    ...
    function handleClick() {
      ...
      if (!ip) {
        if (msg) {
          ...
          msg.textContent = de ? "Bitte zuerst die IP-Adresse des deCONZ-Gateways eingeben." : "Please enter the deCONZ gateway IP address first.";
        }
        return;
      }
      if (btn) {
        btn.disabled = true;
        btn.textContent = de ? "Warte auf Pairing\u2026" : "Waiting for pairing\u2026";
      }
      if (msg) {
        msg.style.background = "#e3f2fd";
        msg.style.color = "#1565c0";
        msg.style.display = "block";
        msg.textContent = de ? "Warte auf deCONZ-Pairing-Fenster (bis zu 60 Sekunden)\u2026" : "Waiting for deCONZ pairing window (up to 60 seconds)\u2026";
      }
      function onDone(res) {
        if (btn) {
          btn.disabled = false;
        ...
        if (res && res.apiKey) {
          ...
          if (msg) {
            ...
            msg.textContent = de ? 'API-Schl\xFCssel \xFCbernommen! Bitte auf \u201ESpeichern" klicken.' : 'API key received! Please click "Save".';
          }
        } else {
          if (msg) {
            msg.style.background = "#ffebee";
    ...
    return import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        de ? "API-Schl\xFCssel automatisch beziehen" : "Obtain API key automatically"
      ),
      import_react.default.createElement(
        "p",
        { style: { fontSize: "0.875rem", color: "#616161", margin: "0 0 14px", lineHeight: 1.5 } },
        de ? "\xD6ffnen Sie in deCONZ/Phoscon: Men\xFC \u2192 Gateway \u2192 App authentifizieren. Klicken Sie dann unten \u2013 der Adapter wartet bis zu 60 Sekunden." : "Open deCONZ/Phoscon: Menu \u2192 Gateway \u2192 Authenticate app. Then click below \u2014 the adapter waits up to 60 seconds."
      ),
      import_react.default.createElement(
        "button",
        {
