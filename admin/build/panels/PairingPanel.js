(() => {
  ...
  // admin/src/panels/PairingPanel.jsx
  var import_react = __toESM(require_react());
  var import_react_dom = __toESM(require_react_dom());
  var TEXTS = {
    de: {
      header: "API-Schl\xFCssel automatisch beziehen",
      hint: "\xD6ffnen Sie in deCONZ/Phoscon: Men\xFC \u2192 Gateway \u2192 App authentifizieren. Klicken Sie dann auf die Schaltfl\xE4che unten \u2013 der Adapter wartet bis zu 60 Sekunden auf das Pairing-Fenster.",
      ...
      success: 'API-Schl\xFCssel \xFCbernommen. Bitte auf \u201ESpeichern" klicken.',
      error: "Fehler: "
    },
    en: {
    ...
    fr: {
      header: "Obtenir la cl\xE9 API automatiquement",
      hint: "Ouvrez deCONZ/Phoscon : Menu \u2192 Passerelle \u2192 Authentifier l'app. Cliquez ensuite sur le bouton ci-dessous \u2014 l'adaptateur attendra jusqu'\xE0 60 secondes.",
      ...
      waiting: "En attente de la fen\xEAtre de couplage deCONZ (jusqu'\xE0 60 secondes)\u2026",
      success: "Cl\xE9 API re\xE7ue. Veuillez cliquer sur \xAB Enregistrer \xBB.",
      error: "Erreur : "
    },
    it: {
      header: "Ottenere la chiave API automaticamente",
      hint: "Apri deCONZ/Phoscon: Menu \u2192 Gateway \u2192 Autentica app. Poi clicca il pulsante sotto \u2014 l'adattatore aspetter\xE0 fino a 60 secondi.",
    ...
    es: {
      header: "Obtener clave API autom\xE1ticamente",
      hint: "Abra deCONZ/Phoscon: Men\xFA \u2192 Gateway \u2192 Autenticar app. Luego haga clic en el bot\xF3n de abajo \u2014 el adaptador esperar\xE1 hasta 60 segundos.",
      btn: "Esperar al emparejamiento deCONZ\u2026",
      btnBusy: "Esperando emparejamiento\u2026",
      noIp: "Por favor, introduzca primero la direcci\xF3n IP del gateway deCONZ.",
    ...
    pl: {
      ...
      hint: "Otw\xF3rz deCONZ/Phoscon: Menu \u2192 Gateway \u2192 Uwierzytelnij app. Nast\u0119pnie kliknij przycisk poni\u017Cej \u2014 adapter b\u0119dzie czeka\u0142 do 60 sekund.",
    ...
    ru: {
      ...
      success: "API-\u043A\u043B\u044E\u0447 \u043F\u043E\u043B\u0443\u0447\u0435\u043D. \u041D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C\xBB.",
      error: "\u041E\u0448\u0438\u0431\u043A\u0430: "
    },
    zh: {
      header: "\u81EA\u52A8\u83B7\u53D6API\u5BC6\u94A5",
  ...
  function PairingPanelApp({ data, socket, instance, onChange, lang }) {
    const [status, setStatus] = import_react.default.useState("idle");
    ...
    const statusBg = status === "success" ? "#e8f5e9" : status === "error" ? "#ffebee" : "#e3f2fd";
  ...
  function PairingPanel(props) {
    if (_mountedEl) {
      setTimeout(function() {
        try {
          import_react_dom.default.render(import_react.default.createElement(PairingPanelApp, props), _mountedEl);
        } catch (_) {
        }
      }, 0);
    }
    return import_react.default.createElement("div", {
      ...
      ref: function(el) {
        ...
        setTimeout(function() {
          try {
            import_react_dom.default.render(import_react.default.createElement(PairingPanelApp, props), el);
          } catch (err) {
            el.innerHTML = '<p style="color:#c62828;padding:8px">\u26A0 Panel error: ' + err.message + "</p>";
          }
        }, 0);
      }
    });
