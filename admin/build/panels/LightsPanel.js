(() => {
  ...
  // admin/src/panels/LightsPanel.jsx
  var import_react11 = __toESM(require_react());
  var import_react_dom = __toESM(require_react_dom());

  // admin/src/components/LightsTab.jsx
  ...
  var ConditionalRule = /* @__PURE__ */ (function() {
    function ConditionalRule2(key, styles25, options) {
      ...
      for (var name in styles25) {
        this.rules.add(name, styles25[name]);
      }
      this.rules.process();
    }
  ...
  var pluginConditionalRule = {
    onCreateRule: function onCreateRule2(key, styles25, options) {
      return keyRegExp.test(key) ? new ConditionalRule(key, styles25, options) : null;
    }
  };
  ...
  var StyleSheet = /* @__PURE__ */ (function() {
    function StyleSheet2(styles25, options) {
      this.attached = false;
      this.deployed = false;
      this.classes = {};
      this.keyframes = {};
    ...
    _proto.addRules = function addRules(styles25, options) {
      var added = [];
      for (var name in styles25) {
        var rule = this.addRule(name, styles25[name], options);
  ...
  var Jss = /* @__PURE__ */ (function() {
    ...
    _proto.createStyleSheet = function createStyleSheet(styles25, options) {
      if (options === void 0) {
        options = {};
      }
      ...
      var sheet = new StyleSheet(styles25, _extends({}, options, {
        jss: this,
  ...
  function getDynamicStyles(styles25) {
    var to = null;
    for (var key in styles25) {
      var value = styles25[key];
  ...
  var GlobalContainerRule = /* @__PURE__ */ (function() {
    function GlobalContainerRule2(key, styles25, options) {
      this.type = "global";
      this.at = at;
      this.isProcessed = false;
      this.key = key;
      ...
      for (var selector in styles25) {
        this.rules.add(selector, styles25[selector]);
      }
      this.rules.process();
    }
  ...
  function jssGlobal() {
    function onCreateRule8(name, styles25, options) {
      if (!name) return null;
      if (name === at) {
        return new GlobalContainerRule(name, styles25, options);
      }
      if (name[0] === "@" && name.substr(0, atPrefix.length) === atPrefix) {
        return new GlobalPrefixedRule(name, styles25, options);
      }
  ...
  function getStylesCreator(stylesOrCreator) {
    ...
    return {
      create: function create2(theme, name) {
        var styles25;
        try {
          styles25 = themingEnabled ? stylesOrCreator(theme) : stylesOrCreator;
        } catch (err) {
          if (false) {
        ...
        var stylesWithOverrides = _extends({}, styles25);
  ...
  function attach(_ref2, props) {
    ...
    if (sheetManager.refs === 0) {
      ...
      var styles25 = stylesCreator.create(theme, name);
      if (!staticSheet) {
        staticSheet = stylesOptions.jss.createStyleSheet(styles25, _extends({
          link: false
        }, options));
        staticSheet.attach();
        if (stylesOptions.sheetsCache) {
      ...
      sheetManager.dynamicStyles = getDynamicStyles(styles25);
    }
  ...
  var withStyles = function withStyles2(stylesOrCreator) {
    ...
    return function(Component) {
      ...
      var useStyles2 = makeStyles(stylesOrCreator, _extends({
  ...
  function createMixins(breakpoints, spacing2, mixins) {
    ...
    return _extends({
      gutters: function gutters() {
        var styles25 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        console.warn(["Material-UI: theme.mixins.gutters() is deprecated.", "You can use the source of the mixin directly:", "\n      paddingLeft: theme.spacing(2),\n      paddingRight: theme.spacing(2),\n      [theme.breakpoints.up('sm')]: {\n        paddingLeft: theme.spacing(3),\n        paddingRight: theme.spacing(3),\n      },\n      "].join("\n"));
        return _extends({
          paddingLeft: spacing2(2),
          paddingRight: spacing2(2)
        }, styles25, _defineProperty({}, breakpoints.up("sm"), _extends({
          paddingLeft: spacing2(3),
          paddingRight: spacing2(3)
        }, styles25[breakpoints.up("sm")])));
      },
      toolbar: (_toolbar = {
        minHeight: 56
  ...
  var Table = /* @__PURE__ */ React8.forwardRef(function Table2(props, ref) {
    var classes = props.classes, className = props.className, _props$component = props.component, Component = _props$component === void 0 ? defaultComponent : _props$component, _props$padding = props.padding, padding = _props$padding === void 0 ? "normal" : _props$padding, _props$size = props.size, size = _props$size === void 0 ? "medium" : _props$size, _props$stickyHeader = props.stickyHeader, stickyHeader = _props$stickyHeader === void 0 ? false : _props$stickyHeader, other = _objectWithoutProperties(props, ["classes", "className", "component", "padding", "size", "stickyHeader"]);
    ...
    return /* @__PURE__ */ React8.createElement(TableContext_default.Provider, {
      value: table
    }, /* @__PURE__ */ React8.createElement(Component, _extends({
  ...
  var TableBody = /* @__PURE__ */ React10.forwardRef(function TableBody2(props, ref) {
    var classes = props.classes, className = props.className, _props$component = props.component, Component = _props$component === void 0 ? defaultComponent2 : _props$component, other = _objectWithoutProperties(props, ["classes", "className", "component"]);
    return /* @__PURE__ */ React10.createElement(Tablelvl2Context_default.Provider, {
      value: tablelvl2
    }, /* @__PURE__ */ React10.createElement(Component, _extends({
  ...
  var TableCell = /* @__PURE__ */ React11.forwardRef(function TableCell2(props, ref) {
    ...
    return /* @__PURE__ */ React11.createElement(Component, _extends({
      ref,
  ...
  var TableHead = /* @__PURE__ */ React13.forwardRef(function TableHead2(props, ref) {
    var classes = props.classes, className = props.className, _props$component = props.component, Component = _props$component === void 0 ? defaultComponent3 : _props$component, other = _objectWithoutProperties(props, ["classes", "className", "component"]);
    return /* @__PURE__ */ React13.createElement(Tablelvl2Context_default.Provider, {
      value: tablelvl22
    }, /* @__PURE__ */ React13.createElement(Component, _extends({
      className: clsx_m_default(classes.root, className),
      ref,
  ...
  var TableRow = /* @__PURE__ */ React14.forwardRef(function TableRow2(props, ref) {
    var classes = props.classes, className = props.className, _props$component = props.component, Component = _props$component === void 0 ? defaultComponent4 : _props$component, _props$hover = props.hover, hover = _props$hover === void 0 ? false : _props$hover, _props$selected = props.selected, selected = _props$selected === void 0 ? false : _props$selected, other = _objectWithoutProperties(props, ["classes", "className", "component", "hover", "selected"]);
    var tablelvl23 = React14.useContext(Tablelvl2Context_default);
    return /* @__PURE__ */ React14.createElement(Component, _extends({
      ref,
  ...
  var ButtonBase = /* @__PURE__ */ React22.forwardRef(function ButtonBase2(props, ref) {
    ...
    return /* @__PURE__ */ React22.createElement(ComponentProp, _extends({
      ...
      /* @__PURE__ */ React22.createElement(TouchRipple_default, _extends({
        ref: rippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null);
  ...
  var Button = /* @__PURE__ */ React23.forwardRef(function Button2(props, ref) {
    ...
    var startIcon = startIconProp && /* @__PURE__ */ React23.createElement("span", {
      className: clsx_m_default(classes.startIcon, classes["iconSize".concat(capitalize(size))])
    }, startIconProp);
    var endIcon = endIconProp && /* @__PURE__ */ React23.createElement("span", {
  ...
  var SvgIcon = /* @__PURE__ */ React24.forwardRef(function SvgIcon2(props, ref) {
    ...
    return /* @__PURE__ */ React24.createElement(Component, _extends({
  ...
  function createSvgIcon(path, displayName) {
    ...
    return /* @__PURE__ */ import_react9.default.memo(/* @__PURE__ */ import_react9.default.forwardRef(Component));
  }

  // node_modules/@material-ui/core/esm/internal/svg-icons/Cancel.js
  var Cancel_default = createSvgIcon(/* @__PURE__ */ React26.createElement("path", {
  ...
  var Chip = /* @__PURE__ */ React27.forwardRef(function Chip2(props, ref) {
    ...
    var chipRef = React27.useRef(null);
    ...
    var Component = ComponentProp || (clickable ? ButtonBase_default : "div");
    var moreProps = Component === ButtonBase_default ? {
      component: "div"
    } : {};
    var deleteIcon = null;
    if (onDelete) {
      ...
      deleteIcon = deleteIconProp && /* @__PURE__ */ React27.isValidElement(deleteIconProp) ? /* @__PURE__ */ React27.cloneElement(deleteIconProp, {
        className: clsx_m_default(deleteIconProp.props.className, classes.deleteIcon, customClasses),
        onClick: handleDeleteIconClick
      }) : /* @__PURE__ */ React27.createElement(Cancel_default, {
        className: clsx_m_default(classes.deleteIcon, customClasses),
        onClick: handleDeleteIconClick
      });
    }
    var avatar = null;
    if (avatarProp && /* @__PURE__ */ React27.isValidElement(avatarProp)) {
      avatar = /* @__PURE__ */ React27.cloneElement(avatarProp, {
    ...
    var icon = null;
    if (iconProp && /* @__PURE__ */ React27.isValidElement(iconProp)) {
      icon = /* @__PURE__ */ React27.cloneElement(iconProp, {
    ...
    return /* @__PURE__ */ React27.createElement(Component, _extends({
      ...
      onKeyUp: handleKeyUp,
      ref: handleRef
    }, moreProps, other), avatar || icon, /* @__PURE__ */ React27.createElement("span", {
  ...
  var CircularProgress = /* @__PURE__ */ React28.forwardRef(function CircularProgress2(props, ref) {
    ...
    return /* @__PURE__ */ React28.createElement("div", _extends({
      ...
      ref,
      role: "progressbar"
    }, rootProps, other), /* @__PURE__ */ React28.createElement("svg", {
  ...
  var Typography = /* @__PURE__ */ React29.forwardRef(function Typography2(props, ref) {
    ...
    return /* @__PURE__ */ React29.createElement(Component, _extends({
  ...
  function StatusDot({ classes, ok, loading }) {
    if (loading) return /* @__PURE__ */ import_react10.default.createElement(CircularProgress_default, { size: 10 });
    return /* @__PURE__ */ import_react10.default.createElement("span", { className: `${classes.dot} ${ok ? classes.dotOk : ok === null ? classes.dotIdle : classes.dotError}` });
  }
  function LightsTab({ sendToAdapter, t, alive }) {
    const classes = useStyles();
    const [lights, setLights] = (0, import_react10.useState)(null);
    ...
    if (alive === false) {
      return /* @__PURE__ */ import_react10.default.createElement("div", { className: `${classes.alert} ${classes.alertWarn}` }, /* @__PURE__ */ import_react10.default.createElement("span", null, "\u26A0\uFE0F"), /* @__PURE__ */ import_react10.default.createElement("span", null, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("msgAdapterOffline"))));
    }
    const rows = lights ? Object.entries(lights) : [];
    const dotOk = !error && lights !== null;
    return /* @__PURE__ */ import_react10.default.createElement("div", { className: classes.root }, /* @__PURE__ */ import_react10.default.createElement("div", { className: classes.bar }, /* @__PURE__ */ import_react10.default.createElement(StatusDot, { classes, ok: error ? false : lights !== null ? true : null, loading }), /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "body2", color: "textSecondary" }, loading && !lights ? t("msgLoading") : error ? t("msgNotConnected") : lights !== null ? `${rows.length} ${t("lightsCount")}` : "\u2013"), /* @__PURE__ */ import_react10.default.createElement("div", { className: classes.spacer }), /* @__PURE__ */ import_react10.default.createElement(Button_default, { variant: "outlined", size: "small", onClick: load, disabled: loading }, loading ? /* @__PURE__ */ import_react10.default.createElement(CircularProgress_default, { size: 14 }) : t("btnRefresh"))), error && /* @__PURE__ */ import_react10.default.createElement("div", { className: `${classes.alert} ${classes.alertError}` }, /* @__PURE__ */ import_react10.default.createElement("span", null, "\u2716"), /* @__PURE__ */ import_react10.default.createElement("div", null, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("msgError"), ":"), " ", error)), loading && !lights && /* @__PURE__ */ import_react10.default.createElement("div", { className: classes.center }, /* @__PURE__ */ import_react10.default.createElement(CircularProgress_default, { size: 36 }), /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "body2" }, t("msgLoading"))), !loading && !error && lights !== null && rows.length === 0 && /* @__PURE__ */ import_react10.default.createElement("div", { className: `${classes.alert} ${classes.alertInfo}` }, /* @__PURE__ */ import_react10.default.createElement("span", null, "\u2139"), /* @__PURE__ */ import_react10.default.createElement("span", null, t("msgNoLights"))), rows.length > 0 && /* @__PURE__ */ import_react10.default.createElement(TableContainer_default, { component: Paper_default, variant: "outlined" }, /* @__PURE__ */ import_react10.default.createElement(Table_default, { size: "small" }, /* @__PURE__ */ import_react10.default.createElement(TableHead_default, { className: classes.tableHead }, /* @__PURE__ */ import_react10.default.createElement(TableRow_default, null, /* @__PURE__ */ import_react10.default.createElement(TableCell_default, null, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("colName"))), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, null, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("colModel"))), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, null, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("colManufacturer"))), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, { align: "center" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("colReachable"))), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, { align: "center" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("colOnOff"))), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, { align: "right" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, t("colBrightness"))))), /* @__PURE__ */ import_react10.default.createElement(TableBody_default, null, rows.map(([id, light2]) => {
      const s = light2.state || {};
      const briPct = s.bri != null ? Math.round(s.bri / 2.54) : null;
      return /* @__PURE__ */ import_react10.default.createElement(TableRow_default, { key: id, className: classes.tableRow }, /* @__PURE__ */ import_react10.default.createElement(TableCell_default, null, /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "body2" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, light2.name)), /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "caption", color: "textSecondary" }, "ID ", id)), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, null, /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "body2" }, light2.modelid || "\u2013")), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, null, /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "body2" }, light2.manufacturername || "\u2013")), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, { align: "center" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: s.reachable ? classes.reachable : classes.unreachable }, s.reachable ? "\u2714" : "\u2717")), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, { align: "center" }, /* @__PURE__ */ import_react10.default.createElement(
        Chip_default,
        {
      ...
      )), /* @__PURE__ */ import_react10.default.createElement(TableCell_default, { align: "right" }, s.reachable && briPct !== null ? /* @__PURE__ */ import_react10.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 6 } }, /* @__PURE__ */ import_react10.default.createElement("div", { style: { width: 48, height: 5, background: "#e0e0e0", borderRadius: 3, overflow: "hidden" } }, /* @__PURE__ */ import_react10.default.createElement("div", { style: { width: `${briPct}%`, height: "100%", background: "#ff9800", borderRadius: 3 } })), /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "caption" }, briPct, " %")) : /* @__PURE__ */ import_react10.default.createElement(Typography_default, { variant: "body2", color: "textSecondary" }, "\u2013")));
    })))));
  }
  ...
  function LightsPanelApp({ socket, instance, lang, alive }) {
    ...
    const sendToAdapter = (0, import_react11.useCallback)(
    ...
    return /* @__PURE__ */ import_react11.default.createElement(LightsTab, { sendToAdapter, t, alive });
  }
  function LightsPanel(props) {
    return import_react11.default.createElement("div", {
      ...
      ref: function(el2) {
        ...
        setTimeout(function() {
          try {
            import_react_dom.default.render(import_react11.default.createElement(LightsPanelApp, props), el2);
          } catch (err) {
