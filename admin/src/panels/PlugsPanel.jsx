...
function PlugsPanelApp({ socket, instance, systemConfig, alive }) {
	...
	return <PlugsTab sendToAdapter={sendToAdapter} t={t} alive={alive} />;
}
...
function PlugsPanel(props) {
	return React.createElement('div', {
		...
		ref: function (el) {
			...
			setTimeout(function () {
				try {
					ReactDOM.render(React.createElement(PlugsPanelApp, props), el);
				} catch (err) {
					el.innerHTML =
