...
function ThermostatsPanelApp({ socket, instance, systemConfig, alive }) {
 ...
 */
function ThermostatsPanel(props) {
	return React.createElement('div', {
		...
		ref: function (el) {
			...
			setTimeout(function () {
				try {
					ReactDOM.render(React.createElement(ThermostatsPanelApp, props), el);
				} catch (err) {
					el.innerHTML =
...
export default ThermostatsPanel;
