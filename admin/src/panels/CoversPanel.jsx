...
function CoversPanelApp({ socket, instance, systemConfig, alive }) {
	...
	return <CoversTab sendToAdapter={sendToAdapter} t={t} alive={alive} />;
}
...
function CoversPanel(props) {
	return React.createElement('div', {
		...
		ref: function (el) {
			...
			setTimeout(function () {
				try {
					ReactDOM.render(React.createElement(CoversPanelApp, props), el);
				} catch (err) {
					el.innerHTML =
